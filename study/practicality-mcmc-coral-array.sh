...
#SBATCH --mem                   30G
#SBATCH --output                log/oed-mcmc-groenendaal-2015.%A_%a.out
#SBATCH --error                 log/oed-mcmc-groenendaal-2015.%A_%a.err
...
#FILE="${PATH2FILES}true_tomek-fit_tomek-row_models-col_measures.txt"
FILE="${PATH2FILES}groenendaal-2015.txt"
declare -A m
...
python -u practicality-mcmc.py $F
